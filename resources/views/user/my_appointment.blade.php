...
<body>
    ...
    <h1 class="heading" align="center" style="margin-top:30px; margin-bottom:30px; font-size: 50px;  padding-bottom:10px;
    box-shadow: 0 10px 10px  #a0ecdb; text-shadow:0 3px 5px  #111;" >Your Appointment</h1>
    ...
    <div align="center" style="padding:70px;">
        ...
        <table style="box-shadow: 5px 10px 10px  #a0ecdb;">
            ...
            <tr style="background-color: white; border: 2px  solid black;" align="center">
                ...
                <td><a class="btn btn-danger" onclick="return confirm('are you sure to delete this')"
                 href="{{url('cancel_appoint',$appoints->id)}}" style="padding:5px;" >cancel</a></td>
            </tr>
    @endforeach
