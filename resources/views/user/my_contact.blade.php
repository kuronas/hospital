    ...
    <nav>
        <div class="nav-bar">
            ...
            <div class="menu">
                ...
                <ul class="nav-links"  style="margin:auto; animation-delay:1s;">
                    <li><a href="/">Home</a></li>
...
@endif
    ...
    box-shadow: 0 10px 10px  #a0ecdb; text-shadow:0 3px 5px  #111;" >Contact Us</h1>
    ...
    <div class="main" style="margin-top:30px;">
       ...
       <div class="images">
       <a target="_blank"  style="text-decoration:none; color:black;" href="https://twitter.com/Kurona_Iro" title="">
       <i class="fa fa-twitter" aria-hidden="true"></i> 
</a>
       </div>
       <div class="titles">
      <p> <a target="_blank"  style="text-decoration:none; color:black;" href="https://twitter.com/Kurona_Iro" title="">
Follow Our Twitter
</a></p>
        ...
        <div class="right box">
          ...
          <div class="content">
            <ul class="icons">
              ...
              <li><a target="_blank"  style="text-decoration:none; color:black;" href="https://twitter.com/Kurona_Iro" ><span class="fab fa-twitter"></span></a></li>
